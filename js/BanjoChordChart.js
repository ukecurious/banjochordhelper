...
const PRESET_LIBRARIES = {
  ...
  'Open D': {
    'C': [[2, 1, 3, 2], [2, 1, 3, 5], [5, 1, 3, 2]],
    'C#': [[3, 2, 4, 3], [3, 2, 4, 6], [6, 2, 4, 3]],
    'D': [[0, 0, 0, 0], [0, 0, 0, 4], [4, 0, 0, 0]],
    'D#': [[1, 1, 1, 1], [1, 1, 1, 5], [5, 1, 1, 1]],
    'E': [[2, 2, 2, 2], [2, 2, 2, 6], [6, 2, 2, 2]],
    'F': [[3, 3, 3, 3], [3, 6, 0, 3], [3, 3, 3, 7]],
    'F#': [[4, 0, 4, 8], [4, 4, 4, 4], [8, 0, 4, 4]],
    'G': [[0, 1, 2, 0], [0, 1, 2, 5], [5, 1, 2, 0]],
    'G#': [[1, 2, 3, 1], [-1, 2, 3, 1], [1, 2, 3, -1]],
    'A': [[2, 3, 4, 2], [-1, 3, 4, 2], [2, 3, 4, -1]],
    'A#': [[0, 4, 1, 3], [3, 4, 1, 0], [0, 4, 8, 0]],
    'B': [[1, 0, 2, 1], [1, 0, 2, 4], [4, 0, 2, 1]],
    'Cm': [[1, 1, 3, 1], [1, 1, 3, 5], [5, 1, 3, 1]],
    'C#m': [[2, 2, 4, 2], [2, 2, 4, 6], [6, 2, 4, 2]],
    'Dm': [[0, 3, 0, 3], [3, 3, 0, 0], [0, 3, 5, 3]],
    'D#m': [[1, 0, 1, 1], [1, 0, 1, 4], [4, 0, 1, 1]],
    'Em': [[2, 1, 2, 2], [2, 1, 2, 5], [5, 1, 2, 2]],
    'Fm': [[3, 2, 3, 3], [3, 2, 3, 6], [6, 2, 3, 3]],
    'F#m': [[4, 0, 4, 7], [4, 3, 4, 4], [4, 7, 0, 4]],
    'Gm': [[0, 1, 1, 0], [0, 1, 1, 5], [5, 1, 1, 0]],
    'G#m': [[1, 2, 2, 1], [-1, 2, 2, 1], [1, 2, 2, -1]],
    'Am': [[2, 3, 3, 2], [2, 6, 0, 2], [-1, 3, 3, 2]],
    'A#m': [[3, 4, 4, 3], [-1, 4, 4, 3], [3, 4, 4, -1]],
    'Bm': [[0, 0, 2, 0], [0, 0, 2, 4], [4, 0, 2, 0]],
    'C7': [[2, 4, 3, 5], [5, 4, 3, 2]],
    'C#7': [[3, 5, 4, 6], [6, 5, 4, 3]],
    'D7': [[0, 0, 0, 10], [10, 0, 0, 0], [0, 0, 3, 7]],
    'D#7': [[1, 4, 4, 5], [5, 4, 4, 1]],
    'E7': [[0, 2, 2, 2], [2, 2, 2, 0]],
    'F7': [[1, 3, 3, 3], [3, 3, 3, 1]],
    'F#7': [[2, 4, 4, 4], [4, 4, 4, 2]],
    ...
    'B7': [[1, 3, 2, 4], [4, 3, 2, 1]],
    'Cm7': [[1, 4, 3, 5], [5, 4, 3, 1]],
    'C#m7': [[2, 5, 4, 6], [6, 5, 4, 2]],
    'Dm7': [[0, 3, 3, 3], [3, 3, 3, 0]],
    'D#m7': [[1, 4, 4, 4], [4, 4, 4, 1]],
    'Em7': [[0, 1, 2, 2], [2, 1, 2, 0]],
    'Fm7': [[1, 2, 3, 3], [3, 2, 3, 1]],
    'F#m7': [[2, 3, 4, 4], [4, 3, 4, 2]],
    'Gm7': [[0, 1, 1, 3], [3, 1, 1, 0]],
    'G#m7': [[1, 2, 2, 4], [4, 2, 2, 1]],
    'Am7': [[2, 3, 3, 5], [5, 3, 3, 2]],
    'A#m7': [[3, 4, 4, 6], [6, 4, 4, 3]],
    'Bm7': [[0, 0, 0, 9], [9, 0, 0, 0], [0, 3, 2, 4]],
    'C6': [[2, 3, 3, 5], [5, 3, 3, 2]],
    'C#6': [[3, 4, 4, 6], [6, 4, 4, 3]],
    'D6': [[0, 0, 0, 9], [9, 0, 0, 0], [0, 3, 2, 4]],
    'D#6': [[1, 4, 3, 5], [5, 4, 3, 1]],
    'E6': [[2, 5, 4, 6], [6, 5, 4, 2]],
    'F6': [[0, 3, 3, 3], [3, 3, 3, 0]],
    'F#6': [[1, 4, 4, 4], [4, 4, 4, 1]],
    ...
    'A#6': [[0, 1, 1, 3], [3, 1, 1, 0]],
    'B6': [[1, 2, 2, 4], [4, 2, 2, 1]],
    'Caug': [[2, 2, 3, 2], [2, 2, 3, 6]],
    'C#aug': [[3, 3, 4, 3], [3, 7, 0, 3]],
    'Daug': [[0, 0, 1, 0], [0, 0, 1, 4]],
    'D#aug': [[1, 1, 2, 1], [1, 1, 2, 5]],
    'Eaug': [[2, 2, 3, 2], [2, 2, 3, 6]],
    'Faug': [[3, 3, 4, 3], [3, 7, 0, 3]],
    'F#aug': [[0, 0, 1, 0], [0, 0, 1, 4]],
    'Gaug': [[1, 1, 2, 1], [1, 1, 2, 5]],
    'G#aug': [[2, 2, 3, 2], [2, 2, 3, 6]],
    'Aaug': [[3, 3, 4, 3], [3, 7, 0, 3]],
    'A#aug': [[0, 0, 1, 0], [0, 0, 1, 4]],
    'Baug': [[1, 1, 2, 1], [1, 1, 2, 5]],
    'Cdim': [[1, 0, 3, 1], [1, 0, 3, 4]],
    'C#dim': [[2, 1, 4, 2], [2, 1, 4, 5]],
    'Ddim': [[0, 2, 5, 3], [3, 2, 5, 0]],
    'D#dim': [[1, 0, 0, 1], [1, 0, 0, 4]],
    'Edim': [[2, 1, 1, 2], [2, 1, 1, 5]],
    'Fdim': [[3, 2, 2, 3], [3, 2, 2, 6]],
    'F#dim': [[4, 0, 3, 7], [4, 3, 3, 4]],
    'Gdim': [[5, 4, 4, 5], [5, 4, 4, 8]],
    'G#dim': [[0, 2, 2, 0], [0, 2, 2, 6]],
    'Adim': [[1, 3, 3, 1], [-1, 3, 3, 1]],
    'A#dim': [[2, 4, 4, 2], [-1, 4, 4, 2]],
    'Bdim': [[0, 5, 2, 3], [3, 5, 2, 0]]
  },
  // Double D: A-D-A-D-F#
  // Strings shown: D-A-D-F#
  'Double D': {
    'C': [[2, 3, 2, 1], [2, 3, 5, 1], [5, 3, 2, 1]],
    'C#': [[3, 4, 3, 2], [3, 4, 6, 2], [6, 4, 3, 2]],
    'D': [[0, 0, 0, 0], [0, 0, 4, 0], [4, 0, 0, 0]],
    'D#': [[1, 1, 1, 1], [1, 1, 5, 1], [5, 1, 1, 1]],
    'E': [[2, 2, 2, 2], [2, 2, 6, 2], [6, 2, 2, 2]],
    'F': [[3, 0, 3, 6], [3, 3, 3, 3], [3, 0, 7, 6]],
    'F#': [[4, 4, 4, 4], [4, 4, 8, 0], [8, 4, 4, 0]],
    'G': [[0, 2, 0, 1], [0, 2, 5, 1], [5, 2, 0, 1]],
    'G#': [[1, 3, 1, 2], [-1, 3, 1, 2], [1, 3, -1, 2]],
    'A': [[2, 4, 2, 3], [-1, 4, 2, 3], [2, 4, -1, 3]],
    'A#': [[0, 1, 3, 4], [3, 1, 0, 4]],
    'B': [[1, 2, 1, 0], [1, 2, 4, 0], [4, 2, 1, 0]],
    'Cm': [[1, 3, 1, 1], [1, 3, 5, 1], [5, 3, 1, 1]],
    'C#m': [[2, 4, 2, 2], [2, 4, 6, 2], [6, 4, 2, 2]],
    'Dm': [[0, 0, 3, 3], [3, 0, 0, 3]],
    'D#m': [[1, 1, 1, 0], [1, 1, 4, 0], [4, 1, 1, 0]],
    'Em': [[2, 2, 2, 1], [2, 2, 5, 1], [5, 2, 2, 1]],
    'Fm': [[3, 3, 3, 2], [3, 3, 6, 2], [6, 3, 3, 2]],
    'F#m': [[4, 0, 4, 7], [4, 4, 4, 3], [4, 4, 7, 0]],
    'Gm': [[0, 1, 0, 1], [0, 1, 5, 1], [5, 1, 0, 1]],
    'G#m': [[1, 2, 1, 2], [-1, 2, 1, 2], [1, 2, -1, 2]],
    'Am': [[2, 0, 2, 6], [2, 3, 2, 3]],
    'A#m': [[3, 4, 3, 4], [-1, 4, 3, 4]],
    'Bm': [[0, 2, 0, 0], [0, 2, 4, 0], [4, 2, 0, 0]],
    'C7': [[2, 3, 5, 4], [5, 3, 2, 4]],
    'C#7': [[3, 4, 6, 5], [6, 4, 3, 5]],
    'D7': [[0, 0, 10, 0], [10, 0, 0, 0], [0, 0, 4, 6]],
    'D#7': [[1, 4, 5, 4], [5, 4, 1, 4]],
    'E7': [[0, 2, 2, 2], [2, 2, 0, 2]],
    'F7': [[1, 3, 3, 3], [3, 3, 1, 3]],
    'F#7': [[2, 4, 4, 4], [4, 4, 2, 4]],
    ...
    'A7': [[2, 4, 5, 3], [5, 4, 2, 3]],
    'A#7': [[0, 1, 3, 2], [3, 1, 0, 2]],
    'B7': [[1, 0, 4, 5], [1, 2, 4, 3], [4, 0, 1, 5]],
    'Cm7': [[1, 3, 5, 4], [5, 3, 1, 4]],
    'C#m7': [[2, 4, 6, 5], [6, 4, 2, 5]],
    'Dm7': [[0, 0, 3, 6], [0, 3, 3, 3], [3, 0, 0, 6]],
    'D#m7': [[1, 4, 4, 4], [4, 4, 1, 4]],
    'Em7': [[0, 2, 2, 1], [2, 2, 0, 1]],
    'Fm7': [[1, 3, 3, 2], [3, 3, 1, 2]],
    'F#m7': [[2, 4, 4, 3], [4, 4, 2, 3]],
    'Gm7': [[0, 1, 3, 1], [3, 1, 0, 1]],
    'G#m7': [[1, 2, 4, 2], [4, 2, 1, 2]],
    'Am7': [[2, 0, 5, 6], [2, 3, 5, 3], [5, 0, 2, 6]],
    'A#m7': [[3, 4, 6, 4], [6, 4, 3, 4]],
    'Bm7': [[0, 0, 9, 0], [9, 0, 0, 0], [0, 0, 4, 5]],
    'C6': [[2, 0, 5, 6], [2, 3, 5, 3], [5, 0, 2, 6]],
    'C#6': [[3, 4, 6, 4], [6, 4, 3, 4]],
    'D6': [[0, 0, 9, 0], [9, 0, 0, 0], [0, 0, 4, 5]],
    'D#6': [[1, 3, 5, 4], [5, 3, 1, 4]],
    'E6': [[2, 4, 6, 5], [6, 4, 2, 5]],
    'F6': [[0, 0, 3, 6], [0, 3, 3, 3], [3, 0, 0, 6]],
    'F#6': [[1, 4, 4, 4], [4, 4, 1, 4]],
    'G6': [[0, 2, 2, 1], [2, 2, 0, 1]],
    'G#6': [[1, 3, 3, 2], [3, 3, 1, 2]],
    'A6': [[2, 4, 4, 3], [4, 4, 2, 3]],
    'A#6': [[0, 1, 3, 1], [3, 1, 0, 1]],
    'B6': [[1, 2, 4, 2], [4, 2, 1, 2]],
    'Caug': [[2, 3, 2, 2], [2, 3, 6, 2]],
    'C#aug': [[3, 0, 3, 7], [3, 4, 3, 3]],
    'Daug': [[0, 1, 0, 0], [0, 1, 4, 0]],
    'D#aug': [[1, 2, 1, 1], [1, 2, 5, 1]],
    'Eaug': [[2, 3, 2, 2], [2, 3, 6, 2]],
    'Faug': [[3, 0, 3, 7], [3, 4, 3, 3]],
    'F#aug': [[0, 1, 0, 0], [0, 1, 4, 0]],
    'Gaug': [[1, 2, 1, 1], [1, 2, 5, 1]],
    'G#aug': [[2, 3, 2, 2], [2, 3, 6, 2]],
    'Aaug': [[3, 0, 3, 7], [3, 4, 3, 3]],
    'A#aug': [[0, 1, 0, 0], [0, 1, 4, 0]],
    'Baug': [[1, 2, 1, 1], [1, 2, 5, 1]],
    'Cdim': [[1, 3, 1, 0], [1, 3, 4, 0]],
    'C#dim': [[2, 4, 2, 1], [2, 4, 5, 1]],
    'Ddim': [[0, 5, 3, 2], [3, 5, 0, 2]],
    'D#dim': [[1, 0, 1, 0], [1, 0, 4, 0]],
    'Edim': [[2, 1, 2, 1], [2, 1, 5, 1]],
    'Fdim': [[3, 2, 3, 2], [3, 2, 6, 2]],
    'F#dim': [[4, 0, 4, 6], [4, 3, 4, 3]],
    'Gdim': [[5, 4, 5, 4], [5, 4, 8, 4]],
    'G#dim': [[0, 2, 0, 2], [0, 2, 6, 2]],
    'Adim': [[1, 3, 1, 3], [-1, 3, 1, 3]],
    'A#dim': [[2, 4, 2, 4], [-1, 4, 2, 4]],
    'Bdim': [[0, 2, 3, 5], [3, 2, 0, 5]]
  },
  // Open C: G-C-G-C-E
  // Strings shown: C-G-C-E
  'Open C': {
    'C': [[0, 0, 0, 0], [0, 0, 4, 0], [4, 0, 0, 0]],
    'C#': [[1, 1, 1, 1], [1, 1, 5, 1], [5, 1, 1, 1]],
    'D': [[2, 2, 2, 2], [2, 2, 6, 2], [6, 2, 2, 2]],
    'D#': [[3, 0, 3, 6], [3, 3, 3, 3]],
    'E': [[4, 4, 4, 4], [4, 4, 8, 0], [8, 4, 4, 0]],
    'F': [[0, 2, 0, 1], [0, 2, 5, 1], [5, 2, 0, 1]],
    'F#': [[1, 3, 1, 2], [-1, 3, 1, 2]],
    'G': [[2, 4, 2, 3], [-1, 4, 2, 3]],
    'G#': [[0, 1, 3, 4], [3, 1, 0, 4]],
    'A': [[1, 2, 1, 0], [1, 2, 4, 0], [4, 2, 1, 0]],
    'A#': [[2, 3, 2, 1], [2, 3, 5, 1], [5, 3, 2, 1]],
    'B': [[3, 4, 3, 2], [3, 4, 6, 2], [6, 4, 3, 2]],
    'Cm': [[0, 0, 3, 3], [3, 0, 0, 3]],
    'C#m': [[1, 1, 1, 0], [1, 1, 4, 0], [4, 1, 1, 0]],
    'Dm': [[2, 2, 2, 1], [2, 2, 5, 1], [5, 2, 2, 1]],
    'D#m': [[3, 3, 3, 2], [3, 3, 6, 2], [6, 3, 3, 2]],
    'Em': [[4, 0, 4, 7], [4, 4, 4, 3], [4, 4, 7, 0]],
    'Fm': [[0, 1, 0, 1], [0, 1, 5, 1], [5, 1, 0, 1]],
    'F#m': [[1, 2, 1, 2], [-1, 2, 1, 2]],
    'Gm': [[2, 0, 2, 6], [2, 3, 2, 3]],
    'G#m': [[3, 4, 3, 4], [-1, 4, 3, 4]],
    'Am': [[0, 2, 0, 0], [0, 2, 4, 0], [4, 2, 0, 0]],
    'A#m': [[1, 3, 1, 1], [1, 3, 5, 1], [5, 3, 1, 1]],
    'Bm': [[2, 4, 2, 2], [2, 4, 6, 2], [6, 4, 2, 2]],
    'C7': [[0, 0, 10, 0], [10, 0, 0, 0], [0, 0, 4, 6]],
    'C#7': [[1, 4, 5, 4], [5, 4, 1, 4]],
    'D7': [[0, 2, 2, 2], [2, 2, 0, 2]],
    'D#7': [[1, 3, 3, 3], [3, 3, 1, 3]],
    'E7': [[2, 4, 4, 4], [4, 4, 2, 4]],
    ...
    'G7': [[2, 4, 5, 3], [5, 4, 2, 3]],
    'G#7': [[0, 1, 3, 2], [3, 1, 0, 2]],
    'A7': [[1, 0, 4, 5], [1, 2, 4, 3], [4, 0, 1, 5]],
    'A#7': [[2, 3, 5, 4], [5, 3, 2, 4]],
    'B7': [[3, 4, 6, 5], [6, 4, 3, 5]],
    'Cm7': [[0, 0, 3, 6], [0, 3, 3, 3], [3, 0, 0, 6]],
    'C#m7': [[1, 4, 4, 4], [4, 4, 1, 4]],
    'Dm7': [[0, 2, 2, 1], [2, 2, 0, 1]],
    'D#m7': [[1, 3, 3, 2], [3, 3, 1, 2]],
    'Em7': [[2, 4, 4, 3], [4, 4, 2, 3]],
    'Fm7': [[0, 1, 3, 1], [3, 1, 0, 1]],
    'F#m7': [[1, 2, 4, 2], [4, 2, 1, 2]],
    'Gm7': [[2, 0, 5, 6], [2, 3, 5, 3], [5, 0, 2, 6]],
    'G#m7': [[3, 4, 6, 4], [6, 4, 3, 4]],
    'Am7': [[0, 0, 9, 0], [9, 0, 0, 0], [0, 0, 4, 5]],
    'A#m7': [[1, 3, 5, 4], [5, 3, 1, 4]],
    'Bm7': [[2, 4, 6, 5], [6, 4, 2, 5]],
    'C6': [[0, 0, 9, 0], [9, 0, 0, 0], [0, 0, 4, 5]],
    'C#6': [[1, 3, 5, 4], [5, 3, 1, 4]],
    'D6': [[2, 4, 6, 5], [6, 4, 2, 5]],
    'D#6': [[0, 0, 3, 6], [0, 3, 3, 3], [3, 0, 0, 6]],
    'E6': [[1, 4, 4, 4], [4, 4, 1, 4]],
    'F6': [[0, 2, 2, 1], [2, 2, 0, 1]],
    'F#6': [[1, 3, 3, 2], [3, 3, 1, 2]],
    'G6': [[2, 4, 4, 3], [4, 4, 2, 3]],
    'G#6': [[0, 1, 3, 1], [3, 1, 0, 1]],
    'A6': [[1, 2, 4, 2], [4, 2, 1, 2]],
    'A#6': [[2, 0, 5, 6], [2, 3, 5, 3], [5, 0, 2, 6]],
    'B6': [[3, 4, 6, 4], [6, 4, 3, 4]],
    'Caug': [[0, 1, 0, 0], [0, 1, 4, 0]],
    'C#aug': [[1, 2, 1, 1], [1, 2, 5, 1]],
    'Daug': [[2, 3, 2, 2], [2, 3, 6, 2]],
    'D#aug': [[3, 0, 3, 7], [3, 4, 3, 3]],
    'Eaug': [[0, 1, 0, 0], [0, 1, 4, 0]],
    'Faug': [[1, 2, 1, 1], [1, 2, 5, 1]],
    'F#aug': [[2, 3, 2, 2], [2, 3, 6, 2]],
    'Gaug': [[3, 0, 3, 7], [3, 4, 3, 3]],
    'G#aug': [[0, 1, 0, 0], [0, 1, 4, 0]],
    'Aaug': [[1, 2, 1, 1], [1, 2, 5, 1]],
    'A#aug': [[2, 3, 2, 2], [2, 3, 6, 2]],
    'Baug': [[3, 0, 3, 7], [3, 4, 3, 3]],
    'Cdim': [[0, 5, 3, 2], [3, 5, 0, 2]],
    'C#dim': [[1, 0, 1, 0], [1, 0, 4, 0]],
    'Ddim': [[2, 1, 2, 1], [2, 1, 5, 1]],
    'D#dim': [[3, 2, 3, 2], [3, 2, 6, 2]],
    'Edim': [[4, 0, 4, 6], [4, 3, 4, 3]],
    'Fdim': [[5, 4, 5, 4], [5, 4, 8, 4]],
    'F#dim': [[0, 2, 0, 2], [0, 2, 6, 2]],
    'Gdim': [[1, 3, 1, 3], [-1, 3, 1, 3]],
    'G#dim': [[2, 4, 2, 4], [-1, 4, 2, 4]],
    'Adim': [[0, 2, 3, 5], [3, 2, 0, 5]],
    'A#dim': [[1, 3, 1, 0], [1, 3, 4, 0]],
    'Bdim': [[2, 4, 2, 1], [2, 4, 5, 1]]
  },
  // G Modal (Sawmill): G-D-G-C-D
  // Strings shown: D-G-C-D
  'G Modal (Sawmill)': {
    'C': [[2, 0, 0, 2], [2, 0, 0, 5], [5, 0, 0, 2]],
    'C#': [[3, 1, 1, 3], [-1, 1, 1, 3]],
    'D': [[0, 2, 2, 4], [0, 2, 6, 0], [4, 2, 2, 0]],
    'D#': [[1, 3, 3, 5], [5, 3, 3, 1]],
    'E': [[2, 4, 4, 6], [6, 4, 4, 2]],
    'F': [[3, 2, 0, 3], [3, 5, 0, 7], [7, 5, 0, 3]],
    'F#': [[4, 3, 1, 4], [-1, 3, 1, 4]],
    'G': [[0, 4, 7, 0], [0, 4, 2, 5], [5, 4, 2, 0]],
    'G#': [[1, 1, 0, 1], [-1, 1, 0, 1]],
    'A': [[2, 2, 1, 2], [-1, 2, 1, 2]],
    'A#': [[0, 3, 2, 3], [0, 3, 5, 0], [3, 3, 2, 0]],
    'B': [[1, 4, 3, 4], [4, 4, 3, 1], [4, 4, 3, 4]],
    'Cm': [[1, 0, 0, 1], [1, 0, 0, 5], [5, 0, 0, 1]],
    'C#m': [[2, 1, 1, 2], [-1, 1, 1, 2]],
    'Dm': [[0, 2, 2, 3], [0, 2, 5, 0], [3, 2, 2, 0]],
    'D#m': [[1, 3, 3, 4], [4, 3, 3, 1]],
    'Em': [[2, 4, 4, 5], [5, 4, 4, 2]],
    'Fm': [[3, 1, 0, 3], [3, 5, 0, 6], [6, 5, 0, 3]],
    'F#m': [[4, 2, 1, 4], [-1, 2, 1, 4]],
    'Gm': [[0, 0, 10, 0], [0, 3, 7, 0], [0, 3, 2, 5]],
    'G#m': [[6, 4, 3, 6], [-1, 4, 3, 6]],
    'Am': [[2, 2, 0, 2], [-1, 2, 0, 2]],
    'A#m': [[3, 3, 1, 3], [-1, 3, 1, 3]],
    'Bm': [[0, 4, 2, 4], [0, 4, 6, 0], [4, 4, 2, 0]],
    'C7': [[2, 3, 0, 5], [5, 3, 0, 2]],
    'C#7': [[6, 6, 5, 9], [9, 6, 5, 6]],
    'D7': [[0, 2, 0, 4], [4, 2, 0, 0]],
    'D#7': [[1, 3, 1, 5], [5, 3, 1, 1]],
    'E7': [[0, 4, 4, 6], [6, 4, 4, 0], [2, 4, 2, 6]],
    'F7': [[1, 2, 0, 3], [3, 2, 0, 1]],
    'F#7': [[2, 3, 1, 4], [4, 3, 1, 2]],
    'G7': [[0, 0, 5, 9], [0, 4, 7, 3], [3, 4, 7, 0]],
    'G#7': [[1, 1, 0, 4], [4, 1, 0, 1]],
    'A7': [[2, 2, 1, 5], [5, 2, 1, 2]],
    'A#7': [[0, 3, 5, 6], [3, 3, 2, 6], [6, 3, 2, 3]],
    'B7': [[4, 4, 3, 7], [7, 4, 3, 4]],
    'Cm7': [[1, 3, 0, 5], [5, 3, 0, 1]],
    'Dm7': [[0, 2, 0, 3], [3, 2, 0, 0]],
    'D#m7': [[1, 3, 1, 4], [4, 3, 1, 1]],
    'Em7': [[0, 4, 4, 5], [5, 4, 4, 0], [2, 4, 2, 5]],
    'Fm7': [[1, 1, 0, 3], [3, 1, 0, 1]],
    'F#m7': [[2, 2, 1, 4], [4, 2, 1, 2]],
    'Gm7': [[0, 0, 5, 8], [0, 3, 7, 3], [3, 3, 7, 0]],
    'G#m7': [[4, 4, 3, 6], [6, 4, 3, 4]],
    'Am7': [[2, 2, 0, 5], [5, 2, 0, 2]],
    'A#m7': [[6, 6, 5, 8], [8, 6, 5, 6]],
    'Bm7': [[0, 4, 6, 7], [7, 4, 6, 0]],
    'C6': [[2, 2, 0, 5], [5, 2, 0, 2]],
    'C#6': [[6, 6, 5, 8], [8, 6, 5, 6]],
    'D6': [[0, 4, 6, 7], [7, 4, 6, 0]],
    ...
    'F6': [[0, 2, 0, 3], [3, 2, 0, 0]],
    'F#6': [[1, 3, 1, 4], [4, 3, 1, 1]],
    'G6': [[0, 4, 4, 5], [5, 4, 4, 0], [2, 4, 2, 5]],
    'G#6': [[1, 1, 0, 3], [3, 1, 0, 1]],
    'A6': [[2, 2, 1, 4], [4, 2, 1, 2]],
    'A#6': [[0, 0, 5, 8], [0, 3, 7, 3], [3, 3, 7, 0]],
    'B6': [[4, 4, 3, 6], [6, 4, 3, 4]],
    'Caug': [[2, 1, 0, 2], [2, 5, 0, 6], [6, 5, 0, 2]],
    'C#aug': [[3, 2, 1, 3], [-1, 2, 1, 3]],
    'Daug': [[0, 3, 2, 4], [0, 3, 6, 0], [4, 3, 2, 0]],
    'D#aug': [[1, 4, 3, 5], [5, 4, 3, 1]],
    'Eaug': [[2, 1, 0, 2], [2, 5, 0, 6], [6, 5, 0, 2]],
    'Faug': [[3, 2, 1, 3], [-1, 2, 1, 3]],
    'F#aug': [[0, 3, 2, 4], [0, 3, 6, 0], [4, 3, 2, 0]],
    'Gaug': [[1, 4, 3, 5], [5, 4, 3, 1]],
    'G#aug': [[2, 1, 0, 2], [2, 5, 0, 6], [6, 5, 0, 2]],
    'Aaug': [[3, 2, 1, 3], [-1, 2, 1, 3]],
    'A#aug': [[0, 3, 2, 4], [0, 3, 6, 0], [4, 3, 2, 0]],
    'Baug': [[1, 4, 3, 5], [5, 4, 3, 1]],
    'Cdim': [[1, 5, 0, 4], [4, 5, 0, 1]],
    'C#dim': [[2, 0, 1, 2], [2, 0, 1, 5], [5, 0, 1, 2]],
    'Ddim': [[0, 1, 2, 3], [0, 1, 5, 0], [3, 1, 2, 0]],
    'D#dim': [[1, 2, 3, 4], [4, 2, 3, 1]],
    'Edim': [[2, 3, 4, 5], [5, 3, 4, 2]],
    'Fdim': [[3, 4, 5, 6], [6, 4, 5, 3]],
    'F#dim': [[4, 2, 0, 4], [4, 5, 0, 7], [7, 5, 0, 4]],
    'Gdim': [[5, 3, 1, 5], [-1, 3, 1, 5]],
    'G#dim': [[0, 4, 8, 0], [0, 4, 2, 6], [6, 4, 2, 0]],
    'Adim': [[1, 2, 0, 1], [-1, 2, 0, 1]],
    'A#dim': [[2, 3, 1, 2], [-1, 3, 1, 2]],
    'Bdim': [[0, 4, 2, 3], [0, 4, 5, 0], [3, 4, 2, 0]]
  },
  // Open A: A-E-A-C#-E
  // Strings shown: E-A-C#-E
  'Open A': {
    'C': [[0, 3, 3, 3], [0, 3, 6, 0], [3, 3, 3, 0]],
    'C#': [[1, 4, 0, 4], [4, 4, 0, 1]],
    'D': [[2, 0, 1, 2], [2, 0, 1, 5], [5, 0, 1, 2]],
    'D#': [[3, 1, 2, 3], [6, 6, 2, 3]],
    'E': [[0, 2, 3, 4], [4, 2, 3, 0], [4, 2, 3, 4]],
    'F': [[1, 3, 4, 5], [5, 3, 4, 1]],
    'F#': [[2, 1, 0, 2], [2, 4, 0, 6], [6, 4, 0, 2]],
    'G': [[3, 2, 1, 3], [-1, 2, 1, 3]],
    'G#': [[4, 3, 2, 4], [-1, 3, 2, 4]],
    'A': [[0, 0, 0, 0], [0, 0, 0, 5], [5, 0, 0, 0]],
    'A#': [[1, 1, 1, 1], [-1, 1, 1, 1]],
    'B': [[2, 2, 2, 2], [-1, 2, 2, 2]],
    'Cm': [[3, 3, 2, 3], [-1, 3, 2, 3]],
    'C#m': [[0, 4, 0, 4], [4, 4, 0, 0], [0, 4, 3, 4]],
    'Dm': [[1, 0, 1, 1], [1, 0, 1, 5], [5, 0, 1, 1]],
    'D#m': [[2, 1, 2, 2], [6, 6, 2, 2]],
    'Em': [[0, 2, 3, 3], [0, 2, 6, 0], [3, 2, 3, 0]],
    'Fm': [[1, 3, 4, 4], [4, 3, 4, 1]],
    'F#m': [[2, 0, 0, 2], [2, 0, 0, 5], [5, 0, 0, 2]],
    'Gm': [[3, 1, 1, 3], [-1, 1, 1, 3]],
    'G#m': [[4, 2, 2, 4], [-1, 2, 2, 4]],
    'Am': [[0, 3, 3, 5], [5, 3, 3, 0]],
    'A#m': [[1, 1, 0, 1], [-1, 1, 0, 1]],
    'Bm': [[2, 2, 1, 2], [-1, 2, 1, 2]],
    'C7': [[0, 3, 6, 6], [3, 3, 3, 6], [6, 3, 3, 3]],
    'C#7': [[1, 2, 0, 4], [4, 2, 0, 1]],
    'D7': [[2, 3, 1, 5], [5, 3, 1, 2]],
    'D#7': [[3, 4, 2, 6], [6, 4, 2, 3]],
    'E7': [[0, 2, 1, 4], [4, 2, 1, 0]],
    ...
    'B7': [[2, 2, 2, 5], [5, 2, 2, 2]],
    'Cm7': [[3, 3, 2, 6], [6, 3, 2, 3]],
    'C#m7': [[0, 2, 0, 4], [4, 2, 0, 0]],
    'Dm7': [[1, 3, 1, 5], [5, 3, 1, 1]],
    'D#m7': [[2, 4, 2, 6], [6, 4, 2, 2]],
    'Em7': [[0, 2, 1, 3], [3, 2, 1, 0]],
    'Fm7': [[1, 3, 2, 4], [4, 3, 2, 1]],
    'F#m7': [[0, 0, 0, 2], [2, 0, 0, 0]],
    'Gm7': [[1, 1, 1, 3], [3, 1, 1, 1]],
    'G#m7': [[2, 2, 2, 4], [4, 2, 2, 2]],
    'Am7': [[0, 0, 6, 8], [8, 0, 6, 0], [0, 3, 6, 5]],
    'A#m7': [[1, 1, 0, 4], [4, 1, 0, 1]],
    'Bm7': [[2, 2, 1, 5], [5, 2, 1, 2]],
    'C6': [[0, 0, 6, 8], [8, 0, 6, 0], [0, 3, 6, 5]],
    'C#6': [[1, 1, 0, 4], [4, 1, 0, 1]],
    'D6': [[2, 2, 1, 5], [5, 2, 1, 2]],
    'D#6': [[3, 3, 2, 6], [6, 3, 2, 3]],
    'E6': [[0, 2, 0, 4], [4, 2, 0, 0]],
    ...
    'A#6': [[1, 1, 1, 3], [3, 1, 1, 1]],
    'B6': [[2, 2, 2, 4], [4, 2, 2, 2]],
    'Caug': [[0, 3, 3, 4], [0, 3, 7, 0], [4, 3, 3, 0]],
    'C#aug': [[1, 0, 0, 1], [1, 0, 0, 5]],
    'Daug': [[2, 1, 1, 2], [-1, 1, 1, 2]],
    'D#aug': [[3, 2, 2, 3], [-1, 2, 2, 3]],
    'Eaug': [[0, 3, 3, 4], [0, 3, 7, 0], [4, 3, 3, 0]],
    'Faug': [[1, 0, 0, 1], [1, 0, 0, 5]],
    'F#aug': [[2, 1, 1, 2], [-1, 1, 1, 2]],
    'Gaug': [[3, 2, 2, 3], [-1, 2, 2, 3]],
    'G#aug': [[0, 3, 3, 4], [0, 3, 7, 0]],
    'Aaug': [[1, 0, 0, 1], [1, 0, 0, 5]],
    'A#aug': [[2, 1, 1, 2], [-1, 1, 1, 2]],
    'Baug': [[3, 2, 2, 3], [-1, 2, 2, 3]],
    'Cdim': [[2, 3, 2, 2], [-1, 3, 2, 2]],
    'C#dim': [[0, 4, 0, 3], [3, 4, 0, 0]],
    'Ddim': [[1, 5, 1, 4], [4, 5, 1, 1]],
    'D#dim': [[2, 0, 2, 2], [2, 0, 2, 5]],
    'Edim': [[0, 1, 3, 3], [3, 1, 3, 0]],
    'Fdim': [[1, 2, 4, 4], [4, 2, 4, 1]],
    'F#dim': [[2, 3, 5, 5], [5, 3, 5, 2]],
    'Gdim': [[3, 1, 0, 3], [3, 4, 0, 6], [6, 4, 0, 3]],
    'G#dim': [[4, 2, 1, 4], [-1, 2, 1, 4]],
    'Adim': [[5, 3, 2, 5], [-1, 3, 2, 5]],
    'A#dim': [[0, 1, 0, 0], [0, 4, 0, 6]],
    'Bdim': [[1, 2, 1, 1], [-1, 2, 1, 1]]
  }
};
...
function ChordDiagram({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, name), voicingCount > 1 ? /*#__PURE__*/React.createElement("button", {
  ...
  }, voicingIndex + 1, "/", voicingCount) : /*#__PURE__*/React.createElement("div", {
    style: {
      height: 20
    }
    ...
    return null;
  }), isNut ? /*#__PURE__*/React.createElement("line", {
    x1: leftPad - 4,
    y1: topPad,
    x2: leftPad + gridW + 4,
    y2: topPad,
  ...
  })), [0, 1, 2, 3].map(s => /*#__PURE__*/React.createElement("line", {
    key: `s${s}`,
    x1: stringX(s),
    y1: topPad,
    x2: stringX(s),
  ...
  }), tuningLabels.map((note, s) => /*#__PURE__*/React.createElement("text", {
    key: `l${s}`,
    x: stringX(s),
    y: h - 3,
    textAnchor: "middle",
...
export default function BanjoChordChart() {
  ...
  const finderResults = useMemo(() => {
    ...
    // All preset tunings
    const allTunings = {
      'Open G (Standard)': COMMON_TUNINGS['Open G (Standard)'],
      ...Object.fromEntries(Object.entries(COMMON_TUNINGS).filter(([k]) => k !== 'Open G (Standard)'))
    };
  ...
  const tuningDisplayName = isCustom ? `Custom Tuning: ${currentTuning.join('-')}` : `${selectedTuning}: ${currentTuning.join('-')}`;
  return /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: "Georgia, 'Times New Roman', serif",
  ...
  }, "Banjo Chord Helper"), /*#__PURE__*/React.createElement("p", {
    style: {
  ...
  }, "Five-string chord diagrams for any tuning"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
  ...
  }, [['charts', 'Chord Charts'], ['finder', 'Chord Finder']].map(([key, label]) => /*#__PURE__*/React.createElement("button", {
    key: key,
    onClick: () => setMode(key),
    style: {
      padding: '7px 20px',
  ...
  }, label)))), mode === 'charts' && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("h2", {
    style: {
      fontFamily: "Georgia, 'Times New Roman', serif",
      fontSize: 22,
      fontWeight: 400,
  ...
  }, "Banjo Chord Charts"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: "'Crimson Pro', Georgia, serif",
      fontSize: 14,
      color: '#555555',
  ...
  }, tuningDisplayName), /*#__PURE__*/React.createElement("div", {
    "data-print-hide": "",
    style: {
      padding: '20px 24px',
      maxWidth: 700,
  ...
  }), "Common Tunings"), /*#__PURE__*/React.createElement("label", {
    style: {
      cursor: 'pointer',
      display: 'flex',
      alignItems: 'center',
  ...
  }), "Custom Tuning")), !isCustom ? /*#__PURE__*/React.createElement("select", {
  ...
  }, Object.entries(COMMON_TUNINGS).map(([name, notes]) => /*#__PURE__*/React.createElement("option", {
    key: name,
    value: name
  }, name, ": ", notes.join('-')))) : /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: "'IBM Plex Mono', monospace",
      fontSize: 11,
      color: '#555555',
  ...
  }, "5th (drone) \u2192 1st string"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 8
    }
  }, customTuning.map((note, i) => /*#__PURE__*/React.createElement("input", {
    key: i,
    type: "text",
    value: note,
    maxLength: 2,
    ...
    onClick: async () => {
      ...
      const drawFooter = pageNum => {
        ...
        doc.text('Banjo Chord Helper', pageW / 2, footerY, {
          align: 'center'
        });
        doc.text('Created by Ukecurious', pageW - margin, footerY, {
          align: 'right'
        });
        doc.text('Find Ukecurious at https://linktr.ee/ukecurious', pageW / 2, footerY + 12, {
          align: 'center'
        });
        doc.setTextColor(0);
      };
      ...
      doc.setFontSize(18);
      doc.text('Banjo Chord Charts', pageW / 2, margin, {
        align: 'center'
      });
      doc.setFont('helvetica', 'normal');
      doc.setFontSize(11);
      doc.text(tuningDisplayName, pageW / 2, margin + 18, {
        align: 'center'
      });
      let curY = margin + 42;
      ...
      const drawChord = (x, y, chordName, frets, labels) => {
        ...
        doc.setFont('helvetica', 'bold');
        doc.setFontSize(11);
        doc.text(chordName, x + dW / 2, y + 10, {
          align: 'center'
        });
        const gx = x + 12;
        const gy = y + nameH;
        ...
        for (let s = 0; s < 4; s++) {
          doc.text(labels[s], gx + s * strSpacing, gy + gh + 10, {
            align: 'center'
          });
        }
        doc.setTextColor(0);
    ...
    }, typeName), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        flexWrap: 'wrap',
        gap: 8,
  ...
  }))), mode === 'finder' && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("h2", {
    style: {
      fontFamily: "Georgia, 'Times New Roman', serif",
      fontSize: 22,
      fontWeight: 400,
  ...
  }, "Banjo Chord Finder"), /*#__PURE__*/React.createElement("div", {
    "data-print-hide": "",
    style: {
      padding: '20px 24px',
      maxWidth: 700,
  ...
  }, "Select a chord to see how it's played across all tunings"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 12,
      alignItems: 'center',
  ...
  }, finderChordName)))), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '8px 24px 40px',
      maxWidth: 900,
      margin: '0 auto'
    }
  }, finderResults.length === 0 && /*#__PURE__*/React.createElement("p", {
    style: {
      textAlign: 'center',
      fontFamily: "'Crimson Pro', Georgia, serif",
      fontSize: 15,
  ...
  }, "No playable voicings found for ", finderChordName, " in any tuning."), finderResults.map(({
    tuningName,
    tuningNotes,
    ...
    }, tuningName), /*#__PURE__*/React.createElement("div", {
      style: {
        fontFamily: "'IBM Plex Mono', monospace",
        fontSize: 12,
        color: '#555555'
      }
    }, tuningNotes.join('-'))), /*#__PURE__*/React.createElement(ChordDiagram, {
    ...
    }, /*#__PURE__*/React.createElement("div", null, v.frets.map(f => f === -1 ? 'X' : f).join('-')), /*#__PURE__*/React.createElement("div", {
      style: {
        color: '#777777',
        fontSize: 12,
        marginTop: 3
  ...
  }, "Chord diagrams show strings 4\u20131 (drone string omitted) \xB7 Voicings for custom tunings are algorithmically generated"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: "'Crimson Pro', Georgia, serif",
      fontSize: 12,
      color: '#888888',
  ...
  }, "This chord chart tool is brought to you by", ' ', /*#__PURE__*/React.createElement("a", {
    href: "https://linktr.ee/ukecurious",
    target: "_blank",
  ...
  }, "Ukecurious"), ".", /*#__PURE__*/React.createElement("br", null), "If you want to support my work, you can", ' ', /*#__PURE__*/React.createElement("a", {
    href: "https://buymeacoffee.com/ukecurious",
    target: "_blank",
    rel: "noopener noreferrer",
    style: {
      color: '#555555',
